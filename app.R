  ...
  sidebarLayout(
    ...
    mainPanel(width = 9,
              ...
              conditionalPanel("input.tab == 'overview'",
                               ...
                               tags$p(style = "margin:4px 0 2px;", class = "atext", textOutput("data_note")),
                               br(),
                                 ...
                                 column(6,
                                        ...
                                        div(class = "info-box amber",
                                            ...
                                            tags$p(style = "margin:6px 0 0;",
                                                   ...
                                                   tags$code("dist \u2264 50 m"), " are averaged (congestion mean). ",
                                                   "Readings from stations with ", tags$code("dist > 50 m"),
    ...
    leaflet(sm) %>%
      ...
      addLegend(
        ...
        title    = paste0(
          ...
          "<small style='font-weight:400;color:#555;'>",
